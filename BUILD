...
DEFAULT_COPT = ["-O0 -g -ggdb -rdynamic"] + select({
  "enable_sse": ["-DENABLE_SSE=ON -maes -msse2 -msse3 -msse4.1 -mpclmul"],
  "//conditions:default": []
})
...
cc_binary(
  ...
  copts = [
    "-I@ladnir_cryptoTools/tests_cryptoTools/ -std=c++14"
  ],
  linkopts = [
    "-pthread",
